...
class Aws_sdk_cloud{
	...
	public function __construct()
	{
		...
		$this->ci->load->config('aws_sdk.php');
		$this->cloudfront = CloudFrontClient::factory([
			'private_key' => 'application/libraries/pk-your-amazon-pk.pem', 
			'key_pair_id' => 'your-key_pair_id'
		]);
	}
	public function __call($name, $arguments=null)
   {
		if(!property_exists($this, $name)) {
			return call_user_func_array(array($this->cloudfront,$name), $arguments);
  		}
   }
   /**
